  ...
  return (
      ...
      <div className="w-full py-5 md:py-10 pb-20">
        <div className="md:ml-20 lg:ml-72 flex flex-col items-center">
          ...
          {/* file input */}
          <form
            className="py-5 w-11/12 h-[340px] md:w-4/5 md:h-[320px] lg:w-3/4 lg:h-[365px] bg-gray-200 rounded-md px-4 mb-10"
          ...
          >
            ...
            <Button
              className="nunito w-full md:w-36 mb-20 md:mb-10"
              type="submit"
              disabled={loading}
            >
              Post
