  ...
  return (
    <div className="w-full py-5 md:py-10 pb-20">
      <div className="md:ml-20 lg:ml-72 flex flex-col items-center">
        ...
        {/* file input */}
        <form
          className={`py-5 w-11/12 h-[340px] md:w-4/5 md:h-[320px] lg:w-3/4 lg:h-[365px] ${theme==='light'?'bg-gray-200':'bg-dark'} rounded-md px-4 mb-10`}
        ...
        >
          {!image ? (
            ...
            <div className="relative h-full">
              ...
              <button
                type="button"
                className={`absolute bottom-3 right-3 p-2 rounded-full ${theme==='light'?'bg-white':'bg-dark'}  text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out`}
          ...
          <div className="w-full py-5 mt-5">
            <Textarea
              variant="standard"
              label="caption"
              className={`nunito ${theme==='light'?'text-black':'text-gray-500'} text-lg`}
              color="blue"
              value={caption}
          ...
          <Button
            className="bg-primary text-sm nunito w-full md:w-36 mb-20 md:mb-10"
            type="submit"
            disabled={loading}
          >
            Post
